...
namespace GenshinCompanionAvalonia.Models
{
    public class Banner : ModelBase
    {
        ...
        public static readonly string[] _fourStarRate = new string[]
        { "0", "1", "2" };
        public static readonly double[] _fiveStarRate = new double[]
        ...
        public static readonly string[] _fourStarPercent = new string[]
        { "0", "1", "2" };
        public static readonly double[] _fiveStarPercent = new double[]
